...
User.create("email":"vgarrett3@arizona.edu","password":"qBpaNbyNHgbV","username":"vgarrett3","name":"Virginia Garrett");
User.create("email":"bgilbert4@imgur.com","password":"vxJvPr1","username":"bgilbert4","name":"Benjamin Gilbert");
User.create("email":"kcooper5@soup.io","password":"X2LcTjHLlXuV","username":"kcooper5","name":"Karen Cooper");
User.create("email":"ehall6@cornell.edu","password":"JnG3jfHlA5nf","username":"ehall6","name":"Earl Hall");
User.create("email":"areed7@networksolutions.com","password":"3wua98N","username":"areed7","name":"Albert Reed");
User.create("email":"arose8@toplist.cz","password":"5WvYoKwifA","username":"arose8","name":"Annie Rose");
User.create("email":"nkelley9@home.pl","password":"YfvuKrHV","username":"nkelley9","name":"Nicole Kelley");
User.create("email":"hgreena@1und1.de","password":"1JixJeAl0m","username":"hgreena","name":"Harold Green");
User.create("email":"jhayesb@cdbaby.com","password":"ojsykUoIXM","username":"jhayesb","name":"Joyce Hayes");
User.create("email":"jbaileyc@purevolume.com","password":"J7GDHBSe0Bn","username":"jbaileyc","name":"Jerry Bailey");
User.create("email":"elarsond@ted.com","password":"ebxwh01lAb3","username":"elarsond","name":"Eric Larson");
User.create("email":"jperrye@cnet.com","password":"xPwtEDPtg","username":"jperrye","name":"Jimmy Perry");
User.create("email":"jfoxf@so-net.ne.jp","password":"XyZXAopio64","username":"jfoxf","name":"Jeffrey Fox");
User.create("email":"rburtong@homestead.com","password":"z7022p5gw5","username":"rburtong","name":"Richard Burton");
User.create("email":"aperkinsh@studiopress.com","password":"EONxtK","username":"aperkinsh","name":"Amanda Perkins");
User.create("email":"ariverai@bbb.org","password":"RCyMudKdf","username":"ariverai","name":"Ann Rivera");
User.create("email":"wbennettj@barnesandnoble.com","password":"WJuYEYKo","username":"wbennettj","name":"Wayne Bennett");
